...
(function (jQuery) {
    (function ($) {
        ...
        function DataView(options) {
            ...
            // events
            var onRowCountChanged = new Remote.Event();
            var onRowsChanged = new Remote.Event();
            var onPagingInfoChanged = new Remote.Event();
            ...
            function setGrouping(groupingInfo) {
                if (!options.groupItemMetadataProvider) {
                    options.groupItemMetadataProvider = new Remote.Data.GroupItemMetadataProvider();
                }
            ...
            /**
             * @param varArgs Either a Remote.Group's "groupingKey" property, or a
            ...
            function addGroupTotals(group) {
                var gi = groupingInfos[group.level];
                var totals = new Remote.GroupTotals();
                totals.group = group;
                group.totals = totals;
             ...
             *
             * @param grid {Remote.Grid} The grid to sync selection with.
             * @param preserveHidden {Boolean} Whether to keep selected items that go out of the
             *     view due to them getting filtered out.
             * @param preserveHiddenOnSelectionChange {Boolean} Whether to keep selected items
             *     that are currently out of the view (see preserveHidden) as selected when selection
             *     changes.
             * @return {Remote.Event} An event that notifies when an internal list of selected row ids
            ...
            function syncGridSelection(grid, preserveHidden, preserveHiddenOnSelectionChange) {
                ...
                var onSelectedRowIdsChanged = new Remote.Event();
