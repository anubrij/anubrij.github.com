...
(function (jQuery) {
    /***
 * Contains core RemoteGrid classes.
 * @module Core
 * @namespace Remote
 */
    ...
    (function ($) {
         ...
         * issues.  An edit controller (such as RemoteGrid) can query if an active edit is in progress
        ...
        function EditorLock() {
            ...
            this.activate = function (editController) {
                ...
                if (activeEditController !== null) {
                    throw "RemoteGrid.EditorLock.activate: an editController is still active, can't activate another editController";
                }
                if (!editController.commitCurrentEdit) {
                    throw "RemoteGrid.EditorLock.activate: editController must implement .commitCurrentEdit()";
                }
                if (!editController.cancelCurrentEdit) {
                    throw "RemoteGrid.EditorLock.activate: editController must implement .cancelCurrentEdit()";
                }
            ...
            this.deactivate = function (editController) {
                if (activeEditController !== editController) {
                    throw "RemoteGrid.EditorLock.deactivate: specified editController is not the currently active one";
                }
