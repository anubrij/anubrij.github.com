...
(function (jQuery) {
    (function ($) {
        ...
        function CellRangeSelector(options) {
            ...
            var _decorator;
            var _self = this;
            var _handler = new Remote.EventHandler();
            var _defaults = {
                selectionCss: {
            ...
            function init(grid) {
                ...
                _decorator = new Remote.CellRangeDecorator(grid, options);
                _grid = grid;
            ...
            function handleDragStart(e, dd) {
                ...
                return _decorator.show(new Remote.Range(cell.row, cell.cell));
            }
            ...
            function handleDrag(e, dd) {
                ...
                _decorator.show(new Remote.Range(dd.range.start.row, dd.range.start.cell, end.row, end.cell));
            }
            ...
            $.extend(this, {
                ...
                "onBeforeCellRangeSelected": new Remote.Event(),
                "onCellRangeSelected": new Remote.Event()
            });
        }
    })(jQuery);
})($raxQuery.$);
